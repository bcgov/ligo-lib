from linker.linker_core.base import CHUNK_SIZE

from linker.linker_core.memory_link import MemoryLink
from linker.linker_core.memory_dedup import MemoryDedup
from linker.linker_core.chunked_link import ChunkedLink
from linker.linker_core.chunked_dedup import ChunkedDedup
